...
import { UserStatusManagementController } from './userStatusManagement.controller';
import UserStatusManagementRepository from './userStatusManagement.repository';
...
@Module({
  ...
  controllers: [UserStatusManagementController],
  providers: [UserStatusManagementService, UserStatusManagementRepository],
  exports: [UserStatusManagementService, UserStatusManagementRepository],
})
export default class UserStatusManagementModule {}
